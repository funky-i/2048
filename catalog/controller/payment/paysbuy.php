		...
		if (isset($this->request->post['result'])) {
			...
			if ($order_info) {
				...
				if (!$order_info['order_status_id']) {
					$this->model_checkout_order->addOrderHistory($order_id, $order_status_id, $this->request->post['result'], true);
				} else {
					$this->model_checkout_order->addOrderHistory($order_id, $order_status_id, $this->request->post['result'], false);
				}
			}
		} else {			
			$this->model_checkout_order->addOrderHistory($order_id, $this->config->get('paysbuy_fail_status_id'));
		}		
