      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-account" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-id"><span data-toggle="tooltip" data-html="true" data-trigger="click" title="<?php echo htmlspecialchars($help_pem); ?>"><?php echo $entry_pem; ?></span></label>
            <div class="col-sm-10"><input type="text" name="push_pem" value="<?php echo $push_pem; ?>" placeholder="<?php echo $entry_pem; ?>" id="entry-secret" class="form-control"/></div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="push_mode" id="input-mode" class="form-control">
                <?php if ($push_mode) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="push_status" id="input-status" class="form-control">
                <?php if ($push_status) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
