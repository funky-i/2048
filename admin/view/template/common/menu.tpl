<nav id="column-left"><?php echo $profile; ?>
  <ul id="menu">
    ...
    <li id="reports"><a class="parent"><i class="fa fa-film fa-fw"></i> <span>Medias</span></a></li>
    <li id="reports"><a class="parent"><i class="fa fa-quote-right fa-fw"></i> <span>Languages</span></a></li>
    <li id="reports"><a class="parent"><i class="fa fa-rocket fa-fw"></i> <span>API</span></a></li>
    <li id="reports"><a class="parent"><i class="fa fa-leaf fa-fw"></i> <span>Forum</span></a></li>
    <!-- <li id="reports"><a class="parent"><i class="fa fa-link fa-fw"></i> <span>API</span></a></li> -->
