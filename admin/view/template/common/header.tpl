  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://www.checkyoursites.com" target="_blank">Cloud Service</a></li>
        <li><a href="http://www.opencartxl.com" target="_blank">Opencart Mobile Apps</a></li>
        <li><a href="http://support.opencartxl.com" target="_blank">Support</a></li>
      </ul>
    </li>
